...
<section class='building-section'>
	...
	<div class='building-two center-text'>
		<h6>Building Two</h6>
	</div>
	<div class='building-three center-text'>
...
<section class='button-section'>
	<div>
		<button class='button-look' onclick="turnOffAlarm()">Turn Off Alarm - 1</button>
	</div>
	<div>
		<button class='button-look'>Turn Off Alarm - 2</button>
	</div>
	<div>
		<button class='button-look'>Turn Off Alarm - 3</button>
	</div>
</section>
